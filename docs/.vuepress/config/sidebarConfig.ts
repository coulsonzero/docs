	...
	"/guide/backend/": [
		{
			...
			collapsable: false,
			sidebarDepth: 1,
			children: ["c.md", "c++.md", "django.md", "flask.md", "go.md", "golang.md", "java.md", "kotlin.md", "pyside6.md", "python.md", "swift.md", "gin.md", "gorm.md", "pyside6.md"],
		},
	],
	"/guide/frontend/": [
		{
	...
	"/guide/operations/": [
		{
			...
			collapsable: false,
			sidebarDepth: 1,
			children: ["linux.md", "mongodb.md", "redis.md", "shell.md", "sql.md"],
		},
	],
	"/guide/other/": [
		{
