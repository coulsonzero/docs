...
1. 下载 jetbrains.zip, 解压得到 fineagent.jar, 将该文件移动到 ～ 目录下

<div style="display: flex; justify-content: center;">
    <button style="
    border: 1px solid #323232; padding: 10px 20px; border-radius: 20px; font-size:1rem;">
        <a href="https://macwk.lanzouo.com/i8eElxh573a" download="" target="_blank" style="text-decoration: none; color: initial;">Download <span style="color:lightcoral">fineagent.jar</span></a>
    </button>
</div>

![jet1](@/assets/mac/jet1.png)

2. 访达中在应用程序界面右键点击 WebStorm，选择“显示包内容”

![jet2](@/assets/mac/jet2.png)
...
```
-javaagent:/Users/coulsonzero/fineagent.jar
```

![jet4](@/assets/mac/jet4.png)
