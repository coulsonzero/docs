import{_ as s,d as n}from"./app.73a9ff34.js";const a={},e=n(`<p>Redis</p><h2 id="\u73AF\u5883\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u73AF\u5883\u5B89\u88C5" aria-hidden="true">#</a> \u73AF\u5883\u5B89\u88C5</h2><blockquote><p>\u5B89\u88C5redis</p></blockquote><div class="language-bash ext-sh"><pre class="language-bash"><code>$ brew <span class="token function">install</span> redis
...
</code></pre></div><blockquote><p>4.\u5173\u95ED\u670D\u52A1</p></blockquote><div class="language-bash ext-sh"><pre class="language-bash"><code>$ brew services stop redis
...
</code></pre></div><h2 id="redisinsight" tabindex="-1"><a class="header-anchor" href="#redisinsight" aria-hidden="true">#</a> RedisInsight</h2><blockquote><p>redis\u53EF\u89C6\u5316\u5DE5\u5177</p></blockquote><h2 id="\u7B80\u4ECB" tabindex="-1"><a class="header-anchor" href="#\u7B80\u4ECB" aria-hidden="true">#</a> \u7B80\u4ECB</h2><blockquote><p>REmote DIctionary Server(Redis)</p><p>Redis \u662F\u4E00\u4E2A\u5F00\u6E90\uFF08BSD\u8BB8\u53EF\uFF09\u7684\uFF0C\u5185\u5B58\u4E2D\u7684\u6570\u636E\u7ED3\u6784\u5B58\u50A8\u7CFB\u7EDF\uFF0C\u5B83\u53EF\u4EE5\u7528\u4F5C\u6570\u636E\u5E93\u3001\u7F13\u5B58\u548C\u6D88\u606F\u4E2D\u95F4\u4EF6</p><p>\u975E\u5173\u7CFB\u578B\u6570\u636E\u5E93</p></blockquote><h2 id="\u6570\u636E\u7ED3\u6784\u7C7B\u578B" tabindex="-1"><a class="header-anchor" href="#\u6570\u636E\u7ED3\u6784\u7C7B\u578B" aria-hidden="true">#</a> \u6570\u636E\u7ED3\u6784\u7C7B\u578B</h2><ul><li>String: \u5B57\u7B26\u4E32</li><li>Hash: \u6563\u5217</li><li>List: \u5217\u8868</li><li>Set: \u96C6\u5408</li><li>Sorted Set: \u6709\u5E8F\u96C6\u5408</li></ul><h2 id="string-\u5B57\u7B26\u4E32" tabindex="-1"><a class="header-anchor" href="#string-\u5B57\u7B26\u4E32" aria-hidden="true">#</a> String \u5B57\u7B26\u4E32</h2><h3 id="\u589E" tabindex="-1"><a class="header-anchor" href="#\u589E" aria-hidden="true">#</a> \u589E</h3><h4 id="append" tabindex="-1"><a class="header-anchor" href="#append" aria-hidden="true">#</a> APPEND</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u5982\u679C\u53D8\u91CF\u5B58\u5728\uFF0C\u5219\u672B\u5C3E\u8FFD\u52A0\uFF0C \u5982\u679C\u53D8\u91CF\u4E0D\u5B58\u5728\uFF0C\u5219\u76F8\u5F53\u4E8ESET</span>
append name <span class="token string">&quot; Zero&quot;</span>
</code></pre></div><h4 id="set" tabindex="-1"><a class="header-anchor" href="#set" aria-hidden="true">#</a> SET</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u53D8\u91CF\u8D4B\u503C\uFF0C\u5982\u679C\u5DF2\u5B58\u5728\u5219\u8986\u76D6</span>
<span class="token keyword">SET</span> name <span class="token string">&quot;Coulson&quot;</span>
</code></pre></div><hr><h3 id="\u67E5" tabindex="-1"><a class="header-anchor" href="#\u67E5" aria-hidden="true">#</a> \u67E5</h3><h4 id="get" tabindex="-1"><a class="header-anchor" href="#get" aria-hidden="true">#</a> GET</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u83B7\u53D6\u5B57\u7B26\u4E32\u7684\u5185\u5BB9</span>
GET name
</code></pre></div><h4 id="getrange" tabindex="-1"><a class="header-anchor" href="#getrange" aria-hidden="true">#</a> GETRANGE</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u8FD4\u56DE\u5B57\u7B26\u4E32\u7D22\u5F15\u5B50\u4E32</span>
getrange name <span class="token number">1</span> <span class="token number">3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="list-\u5217\u8868" tabindex="-1"><a class="header-anchor" href="#list-\u5217\u8868" aria-hidden="true">#</a> List \u5217\u8868</h2><h3 id="\u589E-1" tabindex="-1"><a class="header-anchor" href="#\u589E-1" aria-hidden="true">#</a> \u589E</h3><blockquote><p>\u5982\u679Clist\u4E0D\u5B58\u5728\uFF0C\u5219\u65B0\u5EFA</p></blockquote><h4 id="lpush-rpush" tabindex="-1"><a class="header-anchor" href="#lpush-rpush" aria-hidden="true">#</a> LPUSH &amp; RPUSH</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u5934\u90E8\u6DFB\u52A0</span>
...
</code></pre></div><hr><h3 id="\u5220" tabindex="-1"><a class="header-anchor" href="#\u5220" aria-hidden="true">#</a> \u5220</h3><h4 id="del" tabindex="-1"><a class="header-anchor" href="#del" aria-hidden="true">#</a> DEL</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u6E05\u7A7A\u6570\u7EC4\u5168\u90E8\u503C</span>
del mylist
...
</code></pre></div><h3 id="\u5220-1" tabindex="-1"><a class="header-anchor" href="#\u5220-1" aria-hidden="true">#</a> \u5220</h3><h4 id="hdel" tabindex="-1"><a class="header-anchor" href="#hdel" aria-hidden="true">#</a> HDEL</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u5220\u9664\u5B57\u6BB5\u5E76\u8FD4\u56DE\u7D22\u5F15</span>
...
</code></pre></div><h3 id="\u5220-2" tabindex="-1"><a class="header-anchor" href="#\u5220-2" aria-hidden="true">#</a> \u5220</h3><h4 id="spop" tabindex="-1"><a class="header-anchor" href="#spop" aria-hidden="true">#</a> SPOP</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u5220\u9664\u6307\u5B9A\u7D22\u5F15\u5143\u7D20\uFF0C\u7D22\u5F15\u8D8A\u754C\u5219\u8FD4\u56DE\u6574\u4E2A\u96C6\u5408\u7684\u6240\u6709\u5143\u7D20\uFF01</span>
...
</code></pre></div><h3 id="\u5220-3" tabindex="-1"><a class="header-anchor" href="#\u5220-3" aria-hidden="true">#</a> \u5220</h3><h4 id="zpopmax-zpopmin" tabindex="-1"><a class="header-anchor" href="#zpopmax-zpopmin" aria-hidden="true">#</a> ZPOPMAX &amp; ZPOPMIN</h4><div class="language-sql ext-sql"><pre class="language-sql"><code><span class="token comment"># \u5220\u9664\u6700\u540E\u4E00\u4E2A\u5143\u7D20</span>
...
</code></pre></div>`,153);function t(p,l){return e}var c=s(a,[["render",t],["__file","redis.html.vue"]]);export{c as default};
