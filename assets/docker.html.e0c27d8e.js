...
</code></pre></div>`,17),u={href:"https://localhost:3000/",target:"_blank",rel:"noopener noreferrer"},k=s(`<h2 id="docker-\u4F7F\u7528-node-\u90E8\u7F72-\u524D\u7AEF\u9879\u76EE" tabindex="-1"><a class="header-anchor" href="#docker-\u4F7F\u7528-node-\u90E8\u7F72-\u524D\u7AEF\u9879\u76EE" aria-hidden="true">#</a> docker \u4F7F\u7528 node \u90E8\u7F72 \u524D\u7AEF\u9879\u76EE</h2><p>Step1. \u65B0\u5EFADockerfile\u6587\u4EF6</p><div class="language-docker ext-docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> node:14-alpine</span>
...
</code></pre></div><h3 id="docker\u90E8\u7F72docker\u5E94\u7528" tabindex="-1"><a class="header-anchor" href="#docker\u90E8\u7F72docker\u5E94\u7528" aria-hidden="true">#</a> docker\u90E8\u7F72docker\u5E94\u7528</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>FROM golang:alpine AS builder
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker-comppose\u90E8\u7F72" tabindex="-1"><a class="header-anchor" href="#docker-comppose\u90E8\u7F72" aria-hidden="true">#</a> docker comppose\u90E8\u7F72</h3><p>docker-compose.yaml</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3.8&#39;</span>

<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">app</span><span class="token punctuation">:</span>
    <span class="token key atrule">build</span><span class="token punctuation">:</span>
      <span class="token key atrule">context</span><span class="token punctuation">:</span> .
    <span class="token key atrule">container_name</span><span class="token punctuation">:</span> gin<span class="token punctuation">-</span>docker
    <span class="token key atrule">image</span><span class="token punctuation">:</span> gin<span class="token punctuation">-</span>docker<span class="token punctuation">-</span>app<span class="token punctuation">:</span>v1
    <span class="token key atrule">ports</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token string">&quot;9000:8080&quot;</span>
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      <span class="token comment"># \u81EA\u52A8\u521B\u5EFA\u6570\u636E\u5E93</span>
      <span class="token key atrule">MYSQL_DSN</span><span class="token punctuation">:</span> <span class="token string">&quot;root:root@tcp/gin-docker?charset=utf8&amp;parseTime=True&amp;loc=Local&quot;</span>
    <span class="token key atrule">depends_on</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> mysql
      <span class="token punctuation">-</span> redis
  <span class="token key atrule">mysql</span><span class="token punctuation">:</span>
    <span class="token comment"># \u5176\u5B83\u7248\u672C\u4F1A\u62A5\u9519\uFF01</span>
    ...
    <span class="token key atrule">ports</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token string">&quot;9306:3306&quot;</span>
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">MYSQL_DATABASE</span><span class="token punctuation">:</span> <span class="token string">&quot;gin-docker&quot;</span>
  ...
  <span class="token key atrule">redis</span><span class="token punctuation">:</span>
    <span class="token key atrule">image</span><span class="token punctuation">:</span> <span class="token string">&quot;redis:6.2.6&quot;</span>
    ...
    <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> /usr/local/redis<span class="token punctuation">:</span>/var/lib/redis
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> always
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Makefile</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>project-name :<span class="token operator">=</span> gin-docker
version :<span class="token operator">=</span> v1.1
PORT :<span class="token operator">=</span> <span class="token number">7000</span>


Today :<span class="token operator">=</span> <span class="token variable"><span class="token variable">$(</span>shell <span class="token function">date</span> +<span class="token string">&quot;%Y-%m-%d&quot;</span><span class="token variable">)</span></span>
filename :<span class="token operator">=</span> build.txt

<span class="token comment"># make help [ shell ]</span>
help:
	@echo <span class="token string">&quot;@Notice:&quot;</span>
	@echo <span class="token string">&quot;	please modify your &#39;project-name&#39;, &#39;version&#39; and &#39;PORT&#39; in Dockerfile!&quot;</span>
	@echo <span class="token string">&quot;@Commands:&quot;</span>
	@echo <span class="token string">&quot;start by docker-compose&quot;</span>
	@echo <span class="token string">&quot;	step 1. &#39;make docker&#39;: to run    your docker-compose image&quot;</span>
	@echo <span class="token string">&quot;	     a. &#39;make start&#39; : to restart the container&quot;</span>
	@echo <span class="token string">&quot;	     b. &#39;make stop&#39;  : to stop    the container&quot;</span>
	@echo <span class="token string">&quot;	step 2. &#39;make remove&#39;: to remove your docker-compose image&quot;</span>
	@echo <span class="token string">&quot;dockerfile&quot;</span>
	@echo <span class="token string">&quot;	1. &#39;make run&#39;   : to run    your project by dockerfile&quot;</span>

<span class="token comment"># make docker  [ \`docker-compose\` ]</span>
docker:
	<span class="token comment"># \u540E\u53F0\u8FD0\u884C</span>
	@docker compose up -d

<span class="token comment"># make remove  [ \`docker-compose\` ]</span>
remove:
	<span class="token comment"># \u5220\u9664\u5F53\u524D\u6240\u6709\u5BB9\u5668</span>
	@docker compose down
	@docker image <span class="token function">rm</span> gin-docker-app



<span class="token comment"># make start  [ run by \`docker-compose\` ]</span>
start:
	<span class="token comment"># \u91CD\u542F\u5F53\u524D\u5BB9\u5668</span>
	@docker restart gin-docker mysql redis

<span class="token comment"># make stop [ stop by \`docker-compose\` ]</span>
stop:
	@docker stop gin-docker mysql redis


<span class="token comment"># make run  [ \`dockerfile\` ]</span>
run:
	@echo <span class="token variable"><span class="token variable">$(</span>Today<span class="token variable">)</span></span> <span class="token operator">&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	@go build <span class="token builtin class-name">.</span>	<span class="token operator">&gt;&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	@docker build -t <span class="token variable"><span class="token variable">$(</span>project-name<span class="token variable">)</span></span><span class="token builtin class-name">:</span><span class="token variable"><span class="token variable">$(</span>version<span class="token variable">)</span></span> <span class="token builtin class-name">.</span> <span class="token operator">&gt;&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	@docker image <span class="token function">ls</span> <span class="token variable"><span class="token variable">$(</span>project-name<span class="token variable">)</span></span>* <span class="token operator">&gt;&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	<span class="token comment">#@docker run --rm -d -p $(PORT):8080 --name $(project-name)-$(PORT) $(project-name):$(version) &gt;&gt; $(filename)</span>
	@docker run -d -p <span class="token variable"><span class="token variable">$(</span>PORT<span class="token variable">)</span></span>:8080 --name <span class="token variable"><span class="token variable">$(</span>project-name<span class="token variable">)</span></span>-<span class="token variable"><span class="token variable">$(</span>PORT<span class="token variable">)</span></span> <span class="token variable"><span class="token variable">$(</span>project-name<span class="token variable">)</span></span><span class="token builtin class-name">:</span><span class="token variable"><span class="token variable">$(</span>version<span class="token variable">)</span></span> <span class="token operator">&gt;&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	@docker <span class="token function">ps</span> -a <span class="token operator">|</span> <span class="token function">grep</span> <span class="token variable"><span class="token variable">$(</span>project-name<span class="token variable">)</span></span> <span class="token operator">&gt;&gt;</span> <span class="token variable"><span class="token variable">$(</span>filename<span class="token variable">)</span></span>
	@echo <span class="token string">&quot;your can open &#39;http://localhost:<span class="token variable"><span class="token variable">$(</span>PORT<span class="token variable">)</span></span>/ping&#39; to view it.&quot;</span>


</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15);function v(m,b){const a=l("ExternalLinkIcon");return i(),o(p,null,[d,n("p",null,[n("a",u,[c("https://localhost:3000/"),t(a)])]),k],64)}var h=e(r,[["render",v],["__file","docker.html.vue"]]);export{h as default};
