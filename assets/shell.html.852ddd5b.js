import{_ as i,r as p,o as c,c as u,a,w as e,F as r,e as l,b as s,d as n}from"./app.62e66966.js";const d={},k=l(`<h1 id="shell" tabindex="-1"><a class="header-anchor" href="#shell" aria-hidden="true">#</a> Shell</h1><h2 id="overview" tabindex="-1"><a class="header-anchor" href="#overview" aria-hidden="true">#</a> Overview</h2><h3 id="hello-world" tabindex="-1"><a class="header-anchor" href="#hello-world" aria-hidden="true">#</a> Hello World</h3><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>shell \u6587\u4EF6\u4EE5 <code>.sh</code> \u4E3A\u540E\u7F00</p><p>\u4F7F\u7528 <code>bash main.sh</code> \u547D\u4EE4\u6267\u884C shell \u811A\u672C</p><p>\u53EF\u5B9A\u4E49\u8F93\u5165\u53C2\u6570\u8FDB\u884C\u7EC8\u7AEF<code>\u4EA4\u4E92</code>\uFF1A <code>bash main.sh start -l</code></p><p>#!\u58F0\u660Ebash\u89E3\u91CA\u5668\u7684\u4F4D\u7F6E <code>#!/bin/bash</code>, \u56E0\u4E3A\u53EF\u80FD\u4F1A\u6709\u591A\u4E2Abash\u7248\u672C, \u5982\u679C\u5347\u7EA7\u4E86bash\u7248\u672C\u540E\u53EF\u8BBE\u7F6E\u4E3A <code>#!/usr/bin/env bash</code></p></div><p><strong>hello.sh</strong></p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre></div>`,16);function h(g,q){const t=p("CodeGroupItem"),o=p("CodeGroup");return c(),u(r,null,[k,a(o,null,{default:e(()=>[a(t,{title:"Bash"},{default:e(()=>[v]),_:1}),a(t,{title:"start.sh"},{default:e(()=>[m]),_:1})]),_:1}),b],64)}var y=i(d,[["render",h],["__file","shell.html.vue"]]);export{y as default};
